/* spencermountain/wtf-plugin-nsfw 0.1.0 MIT */
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
	typeof define === 'function' && define.amd ? define(factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["wtf-plugin-nsfw"] = factory());
	...
	var patterns$2;
	var hasRequiredPatterns$2;

	function requirePatterns$2 () {
		if (hasRequiredPatterns$2) return patterns$2;
		hasRequiredPatterns$2 = 1;
		patterns$2 = {
		  Sexuality: [/\bsex\b/i],
	...
	var mapping$2;
	var hasRequiredMapping$2;

	function requireMapping$2 () {
		if (hasRequiredMapping$2) return mapping$2;
		hasRequiredMapping$2 = 1;
		mapping$2 = {
	...
	var _byPattern;
	var hasRequired_byPattern;

	function require_byPattern () {
		if (hasRequired_byPattern) return _byPattern;
		hasRequired_byPattern = 1;
	...
	var byTemplate_1;
	var hasRequiredByTemplate;

	function requireByTemplate () {
		if (hasRequiredByTemplate) return byTemplate_1;
		hasRequiredByTemplate = 1;
		const patterns = requirePatterns$2();
		const mapping = requireMapping$2();
		const byPattern = require_byPattern();
	...
	function requirePatterns$1 () {
		if (hasRequiredPatterns$1) return patterns$1;
	...
	var mapping$1;
	var hasRequiredMapping$1;

	function requireMapping$1 () {
		if (hasRequiredMapping$1) return mapping$1;
		hasRequiredMapping$1 = 1;
		mapping$1 = {
	...
	function requireOkay () {
		if (hasRequiredOkay) return okay;
		hasRequiredOkay = 1;
		okay = {
	...
	var byCategory_1;
	var hasRequiredByCategory;

	function requireByCategory () {
		if (hasRequiredByCategory) return byCategory_1;
		hasRequiredByCategory = 1;
		const patterns = requirePatterns$1();
		const mapping = requireMapping$1();
		const okay = requireOkay();
		const byPattern = require_byPattern();
	...
	var byTitle_1;
	var hasRequiredByTitle;

	function requireByTitle () {
		if (hasRequiredByTitle) return byTitle_1;
		hasRequiredByTitle = 1;
		const mapping = requirePatterns();
		const patterns = requirePatterns();
		const byPattern = require_byPattern();
		const paren = /\((.*)\)$/;
	...
	var byImage_1;
	var hasRequiredByImage;

	function requireByImage () {
		if (hasRequiredByImage) return byImage_1;
		hasRequiredByImage = 1;
	...
	function requireSrc () {
		...
		hasRequiredSrc = 1;
		const byTemplate = requireByTemplate();
		const byCategory = requireByCategory();
		const byTitle = requireByTitle();
		const byImage = requireByImage();
